    ...
    public class Commands : BaseCommand<RendezvousFighting>
    {
        ...
        public override void ExecuteCommand(string character, IEnumerable<string> args, string channel)
        {
                ...
                Plugin.FChatClient.SendPrivateMessage("[u][b]General Commands[/b][/u]" + "\n" +
                    ...
                    "[b]!commands[/b]: Makes the bot PM all the commands available to you." + "\n" +
                    "\n" +
                    "\n" +
                    "[u][b]Infight commands[/b][/u]" + "\n" +
                    "[b]!target[/b]: Changes your target. Must be followed by the name of the person you wish to target. Example: !target Mayank" + "\n" +
